...
function Login() {
    ...
    const submit = () => {
        ...
        axios.post('http://localhost:4000/api/log', { email, password }).then((res) => {
            ...
            if (error) {
             ...
             localStorage.setItem("user",JSON.stringify(res.data))   //in postman json,browser to show stringify used
              navigate("/home")
            }
        })
